...
class ModificationAccepted(ResponseBase):
    """
    Event indicating that the requested modification has been acknowledged by the broker and that the updated order parameters are active at the execution venue.
